...
Original file is located at
    https://colab.research.google.com/drive/1emfqC3jRtmDVEgeBcCUC2q4tJgG0FChf
"""
...
# ------------------------
# Extract zip files (Colab paths)
# ------------------------
with zipfile.ZipFile("/content/rf_model.zip", 'r') as zip_ref:
    zip_ref.extractall("/content/models_zip")

with zipfile.ZipFile("/content/scaler.zip", 'r') as zip_ref:
    zip_ref.extractall("/content/models_zip")

# ------------------------
# Load models and scaler
# ------------------------
with open("/content/models_zip/rf_model.pkl", "rb") as f:
    rf_model = pickle.load(f)

with open("/content/models_zip/scaler.pkl", "rb") as f:
    scaler = pickle.load(f)

# Already unzipped files
ann_model = load_model("/content/ann_model.keras")

with open("/content/log_model.pkl", "rb") as f:
